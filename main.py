...
def env_check():
    ...
    print(f"{'LINK_REDIRECT_PREFIX:':<25} {'[可选]':<8} {os.getenv('LINK_REDIRECT_PREFIX', '⚪ 未配置')} (支持{{url}}占位符，优先于REDIRECT_BASE_URL)")
    print(f"{'REDIRECT_BASE_URL:':<25} {'[可选]':<8} {os.getenv('REDIRECT_BASE_URL', '⚪ 未配置')} (infuse/forward 内置302中转地址)")
    print("\n━━━━━━━━ 📝 日志配置 ━━━━━━━━")
